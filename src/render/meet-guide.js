...
export const GUIDES = {
  ...
  logroll: {
    ...
    steps: [
      ...
      ['🏃', 'あるく', '<b>丸太が回るので横へ転がされます。</b>逆らって歩き続けないと、横から海に落ちます'],
      ['🕳', 'よける', '丸太には<b>切れ目</b>があります。回って上がってくると足場が消えるので、丸太の長さ方向へ歩いて逃げます'],
      ['🌊', 'おちる', '落ちたら海。その回はそこで終わりで、岸へ戻されます'],
    ],
    tips: [
      '<b>全開で逆らうと、今度は反対側へ行きすぎて落ちます。</b>流れの速さに合わせて足踏みするのがコツです',
      '<b>回る速さはだんだん上がります。</b>終盤は歩き通しでないと残れません',
      '切れ目は回ってくるのが見えます。来る前に、切れ目の無いところへずれておきます',
      'てっぺんに居るほど安全です。転がされたら、まずてっぺんへ戻ります',
    ],
