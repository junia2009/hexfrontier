...
export const GUIDES = {
  ...
  logroll: {
    ms: 90000,
    goal: '沖に浮かぶ<b>回る丸太</b>の上で生き残ります。順位は<b>落ちずにいた時間</b>。最後のひとりになったら終わりです。',
    steps: [
      ['🪵', 'のる', 'はじまると、みんな筏の上に立たされます。はじめの3秒は丸太が回りません'],
      ['🏃', 'あるく', '<b>丸太は片側へ流れています。</b>流れに逆らって歩き続けないと、端から落ちます'],
      ['🕳', 'よける', '丸太には<b>切れ目</b>があります。回って上に来ると足場が消えるので、丸太の長さ方向へずれてよけます'],
      ['🌊', 'おちる', '落ちたら海。その回はそこで終わりで、岸へ戻されます'],
    ],
    tips: [
      '<b>全開で逆らうと、今度は反対の端から落ちます。</b>流れの速さに合わせて足踏みするのがコツです',
      '丸太は1本ずつ速さが違います。ゆるい丸太へ移れば楽になりますが、渡るあいだは切れ目が読めません',
      '切れ目は回ってくるのが見えます。来る前に、切れ目の無いところへずれておきます',
      'ジャンプで丸太をまたげます。流れから一瞬だけ切り離されるので、立て直しにも使えます',
    ],
    note: '丸太の並びと切れ目は<b>その回の種</b>で決まります。同じ回なら全員がまったく同じ筏に乗っています。',
  },
  daifugo: {
    autoMs: 45000,
