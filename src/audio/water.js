...
const WATER = {
  ...
  dive: {
    impact: { at: 0, freq: 1800, q: 0.6, dur: 0.05, gain: 0.340, sweep: 0.3 },
    cavity: { at: 0.01, freq: 300, q: 0.5, dur: 0.22, gain: 0.260, sweep: 0.35 },
    bubbles: {
      at: 0.004, n: 280, fLo: 360, fHi: 6500,
      spread: 0.55, decay: 3.0, rise: 0.30, gain: 0.300, dur: 1.1,
    },
  },
  ...
  plop: {
    ...
    bubbles: {
      ...
      spread: 0.16, decay: 6.0, rise: 0.38, gain: 0.150, dur: 0.4,
    },
  },
  // 魚が水面で暴れる。叩きが強く、泡はその中間
  thrash: {
    impact: { at: 0, freq: 1400, q: 0.7, dur: 0.045, gain: 0.240, sweep: 0.4 },
    cavity: { at: 0.01, freq: 340, q: 0.5, dur: 0.10, gain: 0.150, sweep: 0.4 },
    bubbles: {
      at: 0.004, n: 120, fLo: 450, fHi: 5500,
      spread: 0.28, decay: 4.5, rise: 0.28, gain: 0.210, dur: 0.55,
    },
  },
};
...
//   minHz    低い泡は「ボヨン」に化ける。泡は基本的に高い。
//   maxLoHz  いちばん低い泡でもここより下げない(同上)。
export const BUBBLE_LIMITS = { minN: 40, minHz: 250, maxLoHz: 900 };
