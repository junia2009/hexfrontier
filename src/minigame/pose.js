...
// 沈みをどれだけ効かせるか。1.0 で「点で見たときの足」がぴったり地面に着く。
//
// **この係数では接地は決まらない。** ここは腰から靴までを点で辿った近似で、
// 実物とはずれる(靴は寝かせたカプセルで、脚を振ると爪先と踵が足首より
// 下がる。腰の前傾も入っていない)。0.7 にすれば足が 0.005 浮くつもりで
// いたが、**実測では逆に 1.3cm 沈んでいた**。
// 接地は walker.js の plantFeet が実物の靴を測って合わせる ── ここは
// 「1歩ごとに腰が沈む」という動きの形だけを受け持つ。
