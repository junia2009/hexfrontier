...
test('縮尺: 人まわりの値どうしの比は縮尺で動かない', () => {
  ...
  // 歩く速さは 1.9 → 1.25 → 1.45 と動かしてきた(motion.js の WALK_SPEED)。
  // 1.9 では体が秒 6.4 回沈んで画面が振動して見え、1.25 では島の端から端に
  // 11 秒かかって遅いと言われた。足りないぶんは駆け足が受け持つ。
  // ── 比を変えたのは、そのつど承知のうえ。
  near(WALK_SPEED / WALKER_RADIUS, 1.45 / 0.10, '歩く速さ ÷ 太さ');
